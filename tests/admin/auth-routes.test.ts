...
describe("auditoria admin auth e rotas protegidas", () => {
  ...
  it("todas as rotas app/api/admin usam requireAdminApiSession", () => {
    ...
    expect(routeFiles.map(relativeToRepo).sort()).toEqual([
      ...
      "app/api/admin/licenses/[licenseId]/mt5-account/route.ts",
      "app/api/admin/licenses/[licenseId]/pause-entries/route.ts",
      "app/api/admin/licenses/[licenseId]/strategy-config/archive/route.ts",
      "app/api/admin/licenses/[licenseId]/strategy-config/draft/route.ts",
      "app/api/admin/licenses/[licenseId]/strategy-config/history/route.ts",
      "app/api/admin/licenses/[licenseId]/strategy-config/publish/route.ts",
      "app/api/admin/licenses/[licenseId]/strategy-config/reset-default/route.ts",
      "app/api/admin/licenses/[licenseId]/strategy-config/route.ts",
      "app/api/admin/master-signals/[masterSignalId]/dispatch/route.ts",
      "app/api/admin/mt5-accounts/ownership/release/route.ts",
      "app/api/admin/mt5-accounts/ownership/trace/route.ts",
      "app/api/admin/mt5-accounts/ownership/transfer/route.ts",
      "app/api/admin/real-trading/approvals/[approvalId]/route.ts",
      "app/api/admin/real-trading/approvals/route.ts",
      "app/api/admin/real-trading/autonomous-strategy/decisions/route.ts",
      "app/api/admin/real-trading/bulk-dispatch/[batchId]/tracking/route.ts",
      "app/api/admin/real-trading/bulk-dispatch/execute/route.ts",
      "app/api/admin/real-trading/bulk-dispatch/preview/route.ts",
      "app/api/admin/real-trading/bulk-dispatch/readiness/route.ts",
      "app/api/admin/real-trading/daily-risk/route.ts",
      "app/api/admin/real-trading/daily-risk/trace/route.ts",
      "app/api/admin/real-trading/dispatch-manual/route.ts",
      "app/api/admin/real-trading/ea-liveness/trace/route.ts",
      "app/api/admin/real-trading/instructions/[instructionId]/close-no-order/route.ts",
      "app/api/admin/real-trading/instructions/[instructionId]/void-false-execution/route.ts",
      "app/api/admin/real-trading/instructions/route.ts",
      "app/api/admin/real-trading/operations/commands/route.ts",
